...
- **Limpieza automática diaria** (opcional): una vez al día borra solo las carpetas de proyectos inactivos ≥ N días (15 por defecto, configurable). Notificación de macOS con lo liberado.
- **Exclusiones**: proyectos en curso que cuyas carpetas no quieres regenerar cada día. Botón ⃠ en cada fila o "Excluir…" con selector de carpeta; el escáner se salta esos árboles enteros (también en la limpieza automática).
